...
### 🧰 Full-Stack Tech Stack & Capabilities
...
| Layer / Domain | Technologies, Frameworks & Tools |
| :--- | :--- |
...
| **🛠️ Dev Tools & Workflow** | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![VS Code](https://img.shields.io/badge/VS_Code-007ACC?style=flat-square&logo=visual-studio-code&logoColor=white) ![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat-square&logo=postman&logoColor=white) ![Windows Terminal](https://img.shields.io/badge/Terminal-4D4D4D?style=flat-square&logo=windows-terminal&logoColor=white) ![Figma](https://img.shields.io/badge/Figma-F24E1E?style=flat-square&logo=figma&logoColor=white) |

</div>

---

### 🚀 Full-Stack & System Architecture Projects
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li><b>Architecture:</b> Full-stack MVC enterprise application with modular backend routing and secure session state.</li>
        <li><b>Security & RBAC:</b> Triple-tier role-based access control for <i>Admin</i>, <i>Trainer</i>, and <i>Member</i> portals.</li>
        <li><b>Analytics:</b> Dynamic data visualization for attendance, revenue, and member subscription lifecycles using Chart.js.</li>
      </ul>
      <p align="center">
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><b>Accessibility:</b> Voice-activated stop announcements powered by the HTML5 Web Speech API.</li>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li><b>AI Agent Pipeline:</b> Autonomous recipe planning and dietary constraint evaluation engine.</li>
        ...
        <li><b>Dynamic Generation:</b> Context-aware ingredient substitution and multi-step culinary execution workflows.</li>
      </ul>
      <p align="center">
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li><b>Interactive UI/UX:</b> Clean component hierarchy with smooth transitions, responsive grid layouts, and dark mode.</li>
        <li><b>Performance:</b> Optimized asset loading, lighthouse score compliance, and automated CI/CD deployment on Vercel/Netlify.</li>
        <li><b>Contact Integration:</b> Seamless direct communication channels and interactive project case studies.</li>
      </ul>
      <p align="center">
        <a href="https://github.com/preyal2/portfolio"><b>💻 View Source Code ↗</b></a> •
...
<div align="center">
  ...
  <p>I'm always excited to collaborate on open-source initiatives, full-stack web platforms, and intelligent AI applications.</p>
